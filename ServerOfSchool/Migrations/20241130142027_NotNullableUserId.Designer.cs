...
namespace ServerOfSchool.Migrations
{
    ...
    [Migration("20241130142027_NotNullableUserId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServerOfSchool.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ServerOfSchool.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ServerOfSchool.Models.Student", b =>
                {
                    b.HasOne("ServerOfSchool.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("StudentProfile")
                        .HasForeignKey("ServerOfSchool.Models.Student", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ServerOfSchool.Models.Teacher", b =>
                {
                    b.HasOne("ServerOfSchool.Models.ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("ServerOfSchool.Models.Teacher", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
